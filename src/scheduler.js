...
function startScheduler() {
  ...
  console.log(`[StelOrder] 🛡️ Freno de paginación ACTIVO (tope ${process.env.STEL_MAX_PAGES || 60} páginas) | Rate limit API: ${process.env.API_RATE_MAX || 4000}/15min | 📊 Medidor de tráfico ACTIVO (log cada 30min + /api/diag/traffic) | 📨 Buzón puente con long-poll (anti-flood). Optimización de coste v9.`);
