...
function renderEmails() {
        ...
        ">
          <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:12px">
            <div style="flex:1;min-width:0">
              ...
              <div style="font-size:13px;color:var(--text3);margin-bottom:4px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                ${email.de}
              </div>
              <div style="font-size:15px;font-weight:${esNuevo?'700':'600'};margin-bottom:6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">
                ${email.asunto}
              </div>
              <div style="font-size:13px;color:var(--text2)">
                💡 ${email.resumen || 'Sin resumen'}
              </div>
  ...
  // Si hay email abierto, renderizar detalle encima
  if (emailsState.emailAbierto) {
    renderDetalle();
  }
}

// ── Render detalle email ──────────────────────────────────────────
    ...
    <div style="background:var(--bg2);border:1px solid var(--border2);border-radius:16px;width:100%;max-width:680px;margin:auto">
      ...
      <div style="padding:20px 24px;border-bottom:1px solid var(--border);display:flex;justify-content:space-between;align-items:flex-start">
        <div style="flex:1">
          <div style="display:flex;gap:8px;flex-wrap:wrap;margin-bottom:10px">
            <span style="background:${c.color}22;color:${c.color};border:1px solid ${c.color}44;border-radius:6px;padding:3px 10px;font-size:13px;font-weight:600">
              ${c.emoji} ${c.label}
            </span>
      ...
      <div style="padding:20px 24px">
        ...
        <div style="background:${remitente.encontrado ? 'rgba(34,196,135,.08)' : 'rgba(240,82,82,.08)'};border:1px solid ${remitente.encontrado ? 'rgba(34,196,135,.3)' : 'rgba(240,82,82,.3)'};border-radius:10px;padding:12px 16px;margin-bottom:16px">
          ...
          ` : `
            <div style="font-size:13px;color:var(--text3)">Este email no corresponde a ningún cliente en StelOrder. Gestiona manualmente.</div>
          `}
        ...
        <div style="background:var(--bg3);border-radius:10px;padding:14px 16px;margin-bottom:16px">
          ...
          <div style="font-size:14px;color:var(--text)">${email.resumen}</div>
